  ...
  offers: [
    {
      ...
      priceCents: 990,
      compareAtCents: null,
      benefits: ["Persönliches Lied als MP3", "Lieferung in 4 Tagen", "Ohne Überarbeitung"],
      revisionLimit: 0,
      deliveryHours: 96,
      recommended: false,
    ...
    },
    {
      ...
      priceCents: 1490,
      compareAtCents: 5090,
      benefits: ["Persönliches Lied als MP3", "Lieferung in 4 Tagen", "1 Überarbeitung inklusive"],
      revisionLimit: 1,
      deliveryHours: 96,
      recommended: false,
      expressEligible: true
    },
    {
      ...
      priceCents: 2490,
      compareAtCents: 8390,
      benefits: ["Persönliches Lied als MP3", "Lieferung in 24 Std. inklusive", "Unbegrenzte Überarbeitungen"],
      revisionLimit: null,
      deliveryHours: 24,
      recommended: true,
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" bgcolor="#fffaf6" style="background-color:#fffaf6;"><tr><td align="center" style="padding:30px 12px 42px;"><table role="presentation" width="640" cellpadding="0" cellspacing="0" style="width:640px;max-width:100%;"><tr><td align="center" style="padding:0 16px 22px;"><img src="${logo}" width="220" alt="Meine Geschichte als Lied" style="display:block;width:220px;max-width:72%;height:auto;border:0;"></td></tr>
<tr><td bgcolor="#fffaf6" style="overflow:hidden;border:1px solid #eadde0;border-radius:32px;background-color:#fffaf6;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td bgcolor="#6f3345" style="height:8px;background-color:#6f3345;font-size:0;line-height:0;">&nbsp;</td></tr><tr><td style="padding:43px 44px 39px;"><span style="display:inline-block;padding:8px 13px;border-radius:999px;background-color:#f7dca8;color:#684616;font-family:Arial,sans-serif;font-size:10px;font-weight:900;letter-spacing:.09em;text-transform:uppercase;">✓ Zahlung bestätigt</span>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" bgcolor="#f0d9d9" style="margin-top:27px;border:1px solid #dfc2ca;border-radius:22px;background-color:#f0d9d9;"><tr><td bgcolor="#f0d9d9" style="padding:23px 24px;background-color:#f0d9d9;color:#2c2023;font-family:Arial,sans-serif;"><div style="font-size:11px;font-weight:900;letter-spacing:.11em;text-transform:uppercase;color:#6f3345;">${escapeHtml(params.orderName)}</div><div style="margin-top:11px;font-family:Georgia,'Times New Roman',serif;font-size:25px;line-height:1.25;color:#2c2023;">${escapeHtml(offer)}</div><div style="margin-top:9px;font-size:14px;line-height:1.5;color:#675b5e;">${escapeHtml(delivery)}</div><div style="margin-top:17px;padding-top:15px;border-top:1px solid #cfaeb8;font-size:18px;font-weight:900;color:#2c2023;">Bezahlt: ${escapeHtml(amount)}</div></td></tr></table>
