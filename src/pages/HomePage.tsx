...
export default function HomePage({ content }: { content: SiteContent }) {
  ...
  return <div className="home-page">
    ...
    <footer><div className="container footer-grid"><div><Logo name={content.brand.name} /><p>Persönliche Lieder aus den Erinnerungen, die euch verbinden.</p></div><div><strong>Hilfe</strong><a href="#faq">FAQ</a><a href={`mailto:${content.brand.supportEmail}`}>Kontakt</a></div><div><strong>Rechtliches</strong><a href="/agb">AGB</a><a href="/widerruf">Widerruf & Erstattung</a><a href="/datenschutz">Datenschutz</a><a href="/impressum">Impressum</a></div></div><div className="container copyright">© 2026 {content.brand.name} · Sichere Zahlung in EUR</div></footer>
  </div>;
}
